...
const SupportLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log('🔍 SupportLogin: Starting support login...');
      
      const response = await authService.supportLogin(formData);
      
      if (response.success) {
        console.log('✅ SupportLogin: Login successful');
        ...
        console.log('❌ SupportLogin: Login failed:', response.message);
        setError(response.message || 'Login failed');
      }
    } catch (error) {
      console.error('❌ SupportLogin: Login error:', error);
