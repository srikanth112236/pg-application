      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Here's what's happening with your PG maintenance today.
          </p>
        </motion.div>
            ...
            <div className="space-y-4">
              <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-900 dark:text-white">No recent activity</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Get started by adding your first PG</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Add PG</p>
                </div>
              </button>
              <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                <div className="text-center">
